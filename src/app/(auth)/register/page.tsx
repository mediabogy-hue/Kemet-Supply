...
import { MerchantInquiryDialog } from '@/app/(auth)/register/_components/merchant-inquiry-dialog';
...
export default function RegisterPage() {
  ...
  // Show loading screen while checking session or if user is being redirected
  if (isSessionLoading || user) {
    return (
