  ...
  return (
    <div
      ...
      className={cn(
        ...
        "group-data-[collapsible=icon]:items-center group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:p-2",
        className
      )}
      {...props}
    />
...
>(({ className, showIcon = false, ...props }, ref) => {
  const [width, setWidth] = React.useState("75%") // Start with a fixed, non-random width.

  // This effect runs only on the client, after hydration.
  React.useEffect(() => {
    // It's now safe to generate and set a random width.
